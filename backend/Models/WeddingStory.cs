...
namespace backend.Models
{
   ...
   public string GroomName { get; set; }
    ...
    public string ThankYouMessage { get; set; }
        ...
        public virtual List<Proposal> Proposals { get; set; } // One-to-many with Proposal
        public virtual List<HowWeMet> HowWeMetStories { get; set; } // One-to-many with HowWeMet
